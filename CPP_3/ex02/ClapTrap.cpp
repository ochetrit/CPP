...
/*   Updated: 2024/11/18 16:58:38 by ochetrit         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
ClapTrap::ClapTrap(void): _hp(10), _stamina(10), _ad(10){
	_name = std::string();
	std::cout << "Welcome to our little unnamed ClapTrap." << std::endl;
}
...
void	ClapTrap::takeDamage(unsigned int amount)
{
	...
	{
		_hp -= amount;
		std::cout << "ClapTrap " << _name << " lose " << amount << " and has now " << _hp << " hp." << std::endl;
	}
}
